...
public class Matriz {
    ...
    public static Matriz trasponerMatriz(Matriz m){     
        ...
        n_filas = m.getDimension().height; 
        n_columnas = m.getDimension().width;             
        
        Matriz matrizResultante = new Matriz(n_columnas, n_filas, false);       
    ...
    public static Matriz multiplicarDosMatrices(Matriz a, Matriz b) throws DimensionesIncompatibles {         
        if(a.getDimension().height != b.getDimension().width) throw new DimensionesIncompatibles("Las matrices no cumplen los requisitos para la multiplicacion de estas");        
